...
os.chdir(r'C:\Users\christina\Documents\GitHub\federated-distance-calculation\result\artificial_datasets\uniform\sample_1200_dim_1000')
with open('sample_1200_dim_1000_results.csv', 'w', newline='') as out_file:
     ...
     for fileName in Path('.').glob('*.txt'):
         ...
         csv_out.writerow(["sample_1200_dim_1000", no_of_spikes, pearson_ADM_PEDM, pearson_ADM_FEDM, pearson_PEDM_FEDM, spearman_ADM_PEDM, spearman_ADM_FEDM, spearman_PEDM_FEDM, method_name])
