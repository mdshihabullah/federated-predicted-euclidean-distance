...
with open('sample_100_dim_1200_results.csv', 'w', newline='') as out_file:
     ...
     for fileName in Path('.').glob('*.txt'):
         ...
         csv_out.writerow(["sample_100_dim_1200", no_of_spikes, pearson_ADM_PEDM, pearson_ADM_FEDM, pearson_PEDM_FEDM, spearman_ADM_PEDM, spearman_ADM_FEDM, spearman_PEDM_FEDM, method_name])
