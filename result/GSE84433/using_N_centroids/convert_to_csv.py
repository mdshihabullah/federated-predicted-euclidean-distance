...
import re
os.chdir(r'C:\Users\christina\Documents\GitHub\federated-distance-calculation\result\GSE84433\using_N_centroids')
with open('GSE84433_N_centroids.csv', 'w', newline='') as out_file:
