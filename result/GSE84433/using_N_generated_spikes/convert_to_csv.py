...
import re
os.chdir(r'C:\Users\christina\Documents\GitHub\federated-distance-calculation\result\GSE84433\using_N_generated_spikes')
with open('GSE84433_N_generated_spikes.csv', 'w', newline='') as out_file:
